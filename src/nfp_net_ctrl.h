...
#define NFP_NET_META_IPSEC		7
#define NFP_NET_META_APP		15 /* app specific meta data */
...
#define   NFP_NET_CFG_STS_LINK_RATE_2500M	  8
#define   NFP_NET_CFG_STS_LINK_RATE_5G		  9
